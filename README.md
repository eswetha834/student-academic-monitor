...
⭐ Project Summary (For Report / Viva)

Online Academic Performance Monitor is a MERN stack-based web application that provides real-time tracking of student academic performance. It enables faculty to manage records and students to monitor their progress through a user-friendly dashboard.
