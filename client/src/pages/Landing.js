    ...
    return (
        <div style={{ minHeight: "100vh", background: "#f8fafc", padding: "40px", textAlign: "center" }}>
            ...
            <p style={{ color: "#64748b", marginBottom: "30px" }}>
                Your app is deployed! Let's test if it works.
            </p>
            ...
            <div style={{ background: "white", padding: "20px", borderRadius: "8px", maxWidth: "600px", margin: "0 auto" }}>
                <h2 style={{ color: "#1e293b", marginBottom: "15px" }}>🚀 Deployment Status</h2>
                <div style={{ textAlign: "left", color: "#64748b" }}>
                    <p>✅ Frontend: Deployed to Vercel</p>
                    <p>✅ Backend: Deployed to Render</p>
                    <p>✅ Database: MongoDB Atlas</p>
                    <p>🔄 Testing: Click Login/Register</p>
                </div>
            </div>
