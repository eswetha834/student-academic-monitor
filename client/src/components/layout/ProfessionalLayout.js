...
import { Menu, X, Bell, User, Settings, LogOut, BarChart3, Calendar, Clock, TrendingUp } from 'lucide-react';

const ProfessionalLayout = ({ children, title, subtitle, sidebarOpen, setSidebarOpen }) => {
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs text-white/60">Professional Analytics</p>
            </div>
            <button 
              onClick={() => setSidebarOpen(false)}
